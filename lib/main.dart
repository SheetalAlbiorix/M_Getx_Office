...
Future<void> main() async {
  final officeDatabase = await OfficeDatabase.instance; // Use the concrete implementation
  final officeRepository = OfficeRepository(officeDatabase: officeDatabase);
  runApp(const MyApp());
}
